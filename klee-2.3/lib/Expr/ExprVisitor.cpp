...
ref<Expr> ExprVisitor::visitActual(const ref<Expr> &e) {
  if (isa<ConstantExpr>(e)) {    
    ...
    case Expr::BitVec: res = visitBitVec(static_cast<BitVecExpr&>(ep)); break;
    case Expr::ArrayEq: res = visitArrayEq(static_cast<ArrayEqExpr&>(ep)); break;
    case Expr::FuncApp: res = visitFuncApp(static_cast<FuncAppExpr&>(ep)); break;
    case Expr::Int: res = visitInt(static_cast<IntExpr&>(ep)); break;
    case Expr::BV2Int: res = visitBV2Int(static_cast<BV2IntExpr&>(ep)); break;
    case Expr::RealInt2BV: res = visitRealInt2BV(static_cast<BV2IntExpr&>(ep)); break;
    case Expr::Constant:
    default:
...
ExprVisitor::Action ExprVisitor::visitForall(const ForallExpr&) {
   return Action::doChildren(); 
}
...
ExprVisitor::Action ExprVisitor::visitBitVec(const BitVecExpr&) {
  return Action::doChildren(); 
}

ExprVisitor::Action ExprVisitor::visitArrayEq(const ArrayEqExpr&) {
  return Action::doChildren(); 
}

ExprVisitor::Action ExprVisitor::visitFuncApp(const FuncAppExpr&) {
  return Action::doChildren(); 
}

ExprVisitor::Action ExprVisitor::visitInt(const IntExpr&) {
  return Action::doChildren(); 
}

ExprVisitor::Action ExprVisitor::visitBV2Int(const BV2IntExpr&) {
  return Action::doChildren(); 
}

ExprVisitor::Action ExprVisitor::visitRealInt2BV(const BV2IntExpr&) {
  return Action::doChildren(); 
}