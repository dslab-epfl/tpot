...
namespace klee {
  ...
  protected:
    ...
    virtual Action visitBitVec(const BitVecExpr&);
    virtual Action visitArrayEq(const ArrayEqExpr&);
    virtual Action visitFuncApp(const FuncAppExpr&);
    virtual Action visitInt(const IntExpr&);
    virtual Action visitBV2Int(const BV2IntExpr&);
    virtual Action visitRealInt2BV(const BV2IntExpr&);
