...
namespace klee {
  ...
  public:
    ...
    /// getInitialValue - Same but for symbolic bitvectors
    virtual ref<Expr> getInitialValue(const BitVecExpr &bv) = 0;

    /// getInitialValue - Same but for symbolic integers
    virtual ref<Expr> getInitialValue(const IntExpr &ie) = 0;
