...
namespace klee {
  ...
  // #define USE_OLD_Z3
  #ifdef USE_OLD_Z3
  typedef long long int bitvec_ce_t;
  typedef long long int int_ce_t;
  #else 
  typedef int64_t bitvec_ce_t;
  typedef int64_t int_ce_t;
  #endif
  ...
  public:
    ...
    virtual bool getCounterExample(
  ...
  Solver *createCoreSolver(CoreSolverType cst, std::string sytInitConstraintsPath);
}
