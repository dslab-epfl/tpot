...
namespace klee {
  ...
  public:
    ...
    // If Klee is invoked by py-syt, this will be set to the path of the smt
    // file containing the initial constraints.
    //! static std::string sytInitConstraintsPath;
    ...
    virtual bool computeCounterExample(
