...
namespace klee {
  ...
  public:
    ...
    // Funcitons that express system invariants.
    std::vector<llvm::Function*> sytInvariants;
    std::vector<llvm::Function*> sytUncheckedInvariants;
    ...
    std::set<llvm::Instruction*> loops;
