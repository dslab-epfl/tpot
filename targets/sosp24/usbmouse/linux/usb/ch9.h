...
struct usb_endpoint_descriptor {
	...
	// TPot: The verifast case study commented bmAtttributed out.
	// We uncomment it so that we can directly use the original linux function
	// in our model for usb_endpoint_is_int_in(...).
	__u8  bmAttributes;
