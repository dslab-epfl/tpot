...
typedef void input_close_t_no_pointer (struct input_dev *dev);//INTERNAL// 
//INTERNAL// 	/*@ requires userdef_input_drvdata(?open_cb, this, ?event_cb)(dev, true, ?data, ?fracsize) &*& not_in_interrupt_context(currentThread)
//INTERNAL// 		&*& input_close_callback_link(this)(open_cb, event_cb);
//INTERNAL// 	@*//*SYNTAX*/
//INTERNAL// 	/*@ ensures  userdef_input_drvdata(open_cb, this, event_cb)(dev, false, data, fracsize)
//INTERNAL// 		&*& input_close_callback_link(this)(open_cb, event_cb)
//INTERNAL// 		&*& [1/2]input_dev_reportable(dev, data)
//INTERNAL// 		&*& not_in_interrupt_context(currentThread); // empirically confirmed with in_interrupt()
//INTERNAL// 	@*//*SYNTAX*/
typedef input_close_t_no_pointer* input_close_t;//INTERNAL// 
//INTERNAL// //@ predicate input_close_t_ghost_param(input_close_t_no_pointer *cb1, input_close_t cb2) = is_input_close_t_no_pointer(cb1) == true &*& cb1 == cb2;
...
//INTERNAL// 	predicate input_dev_unregistered_private(struct input_dev *input_dev, void *userdata);

//INTERNAL// 	predicate input_dev_unregistered(struct input_dev *input_dev, char *name,  char *phys, input_open_t open_callback, input_close_t close_cb, input_event_t event_cb, void *userdata) =
//INTERNAL// 		input_dev_open(input_dev, open_callback) // "input_dev->open" conflicts with parsing of open ghost statement I guess.
//INTERNAL// 		&*& input_dev_close(input_dev, close_cb)
//INTERNAL// 		&*& input_dev->event |-> event_cb
//INTERNAL// 		&*& input_dev->name |-> name
//INTERNAL// 		&*& input_dev->phys |-> phys
//INTERNAL// 		&*& input_dev->id.bustype |-> _
//INTERNAL// 		&*& input_id_vendor(&input_dev->id, _)
//INTERNAL// 		&*& input_id_product(&input_dev->id, _)
//INTERNAL// 		&*& input_id_version(&input_dev->id, _)
//INTERNAL// 		&*& input_dev_unregistered_private(input_dev, userdata)
		
//INTERNAL// 		&*& input_dev->evbit |-> ?evbit
//INTERNAL// 		&*& input_dev->ledbit |-> ?ledbit
//INTERNAL// 		&*& input_dev->keybit |-> ?keybit
//INTERNAL// 		&*& ints(evbit, 1, _)
//INTERNAL// 		&*& ints(ledbit, 1, _)
//INTERNAL// 		&*& ints(keybit, 24, _)
//INTERNAL// 		
//INTERNAL// 		&*& input_dev->led |-> ?led
//INTERNAL// 		&*& uints(led, 1, _)
//INTERNAL// 	;//SYNTAX//
...
//INTERNAL// 	predicate_family userdef_input_drvdata
//INTERNAL// 	(
//INTERNAL// 		input_open_t *open_cb,
//INTERNAL// 		input_close_t *close_cb,
//INTERNAL// 		input_event_t *event_cb
//INTERNAL// 	)(//SYNTAX//
//INTERNAL// 		struct input_dev *input_dev, bool is_opened, void *data, real fracsize	
//INTERNAL// 	);//SYNTAX//
...
//INTERNAL// 	predicate_family input_open_callback_link(input_open_t open_cb)(input_close_t close_cb, input_event_t event_t);
//INTERNAL// 	predicate_family input_close_callback_link(input_close_t close_cb)(input_open_t open_cb, input_event_t event_t);
//INTERNAL// 	predicate_family input_event_callback_link(input_event_t event_t)(input_open_t open_cb, input_close_t close_cb);
...
//INTERNAL// 	predicate input_dev_reportable(struct input_dev *input_dev, void *userdata;);
@*/
...
//INTERNAL// 		&*& result != 0 ?
//INTERNAL// 			// You can already report keys before registering the device.
//INTERNAL// 			input_dev_reportable(result,  0)
			
//INTERNAL// 			&*& input_dev_unregistered(result, 0, 0, _, _, _, 0)
//INTERNAL// 		:
//INTERNAL// 			true
//INTERNAL// 		;//SYNTAX//
//INTERNAL// 		   @*///SYNTAX//
...
//INTERNAL// 		&*& dev != 0 ?
//INTERNAL// 			input_dev_unregistered(dev, ?name, ?phys, ?open_cb, ?close_cb, ?event_cb, ?userdata)
//INTERNAL// 			&*& input_dev_reportable(dev, userdata)
		:
//INTERNAL// 			true // no-op.
//INTERNAL// 		;//SYNTAX//
//INTERNAL// 	@*///SYNTAX//
...
//INTERNAL// lemma int input_ghost_register_device(struct input_dev *dev, real fracsize);
//INTERNAL// 	requires input_dev_unregistered(dev, ?name, ?phys, ?open_cb, ?close_cb, ?event_cb, ?userdata);
//INTERNAL// 	ensures input_dev_ghost_registered(dev, name, phys, open_cb, close_cb, event_cb, userdata, fracsize, result);

//INTERNAL// predicate maybe_chars(real f, char* p, int length, list<char> data;) =
//INTERNAL//   p == 0 ?
//INTERNAL//     true
//INTERNAL//   ://SYNTAX//
//INTERNAL//     [f]chars(p, length, data); 
//INTERNAL// @*///SYNTAX//

int input_register_device(struct input_dev *dev);
/*INTERNAL*/ 	/*@ requires input_dev_ghost_registered(dev, ?name, ?phys, ?open_cb, ?close_cb, ?event_cb, ?userdata, ?fracsize, ?ghost_result)
//INTERNAL// 		&*& input_open_t_ghost_param(open_cb, open_cb)
//INTERNAL// 		&*& input_close_t_ghost_param(close_cb, close_cb)
//INTERNAL// 		&*& input_event_t_ghost_param(event_cb, event_cb)
//INTERNAL// 		&*& input_open_callback_link(open_cb)(close_cb, event_cb)
//INTERNAL// 		&*& input_close_callback_link(close_cb)(open_cb, event_cb)
//INTERNAL// 		&*& input_event_callback_link(event_cb)(open_cb, close_cb)
//INTERNAL// 		&*& [?f]chars(name, ?name_length, ?cs) &*& mem('\0', cs) == true
//INTERNAL// 		&*& maybe_chars(?f2, phys, ?phys_length, ?cs2) &*& phys == 0 || mem('\0', cs2) == true
		
//INTERNAL// 		&*& [1/2]input_dev_reportable(dev, userdata) // why [1/2]? See comments at predicate.
		
		// "input_register_device() may sleep" -- input-programming.txt
		&*& not_in_interrupt_context(currentThread)
		
//INTERNAL// 		&*& ghost_result == 0 ?
//INTERNAL// 			userdef_input_drvdata(open_cb, close_cb, event_cb)(dev, false, userdata, fracsize)
//INTERNAL// 		: true//SYNTAX//
//INTERNAL// 		;//SYNTAX//
//INTERNAL// 	@*///SYNTAX//
/*INTERNAL*/ 	/*@ ensures
		not_in_interrupt_context(currentThread)
//INTERNAL// 		&*& result == ghost_result
//INTERNAL// 		&*& result == 0 ? // success
//INTERNAL// 			input_dev_registered(dev, name, name_length, f, phys, phys_length, f2, open_cb, close_cb, event_cb, userdata, fracsize)
		: // failure
...
//INTERNAL// 			&*& input_close_callback_link(close_cb)(open_cb, event_cb)
//INTERNAL// 			&*& input_event_callback_link(event_cb)(open_cb, close_cb)
//INTERNAL// 			&*& [f]chars(name, name_length, cs)
//INTERNAL// 			&*& maybe_chars(f2, phys, phys_length, cs2)
			
			// Not consumed on failure, so also not given back. See input_dev_ghost_registered
//INTERNAL// 			//&*& userdef_input_drvdata(dev, false, open_cb, close_cb, event_cb, userdata, fracsize)
			
//INTERNAL// 			&*& [1/2]input_dev_reportable(dev, userdata)
		;
	@*/
...
//INTERNAL// 	/*@ requires
//INTERNAL// 		input_dev_registered(dev, ?name, ?name_length, ?name_frac, ?phys, ?phys_length, ?phys_frac, ?open_cb, ?close_cb, ?event_cb, ?userdata, ?fracsize)
...
//INTERNAL// 		&*& input_close_callback_link(close_cb)(open_cb, event_cb)
//INTERNAL// 		&*& input_event_callback_link(event_cb)(open_cb, close_cb)
//INTERNAL// 		&*& [name_frac]chars(name, name_length, _)
//INTERNAL// 		&*& maybe_chars(phys_frac, phys, phys_length, _);
//INTERNAL// 	@*///SYNTAX//

void input_set_drvdata(struct input_dev *dev, void *data);
//INTERNAL// 	/*@ requires
//INTERNAL// 		input_dev_unregistered(dev, ?name, ?phys, ?open_cb, ?close_cb, ?event_cb, ?original_userdata)
//INTERNAL// 		&*& input_dev_reportable(dev, original_userdata);
//INTERNAL// 	@*///SYNTAX//
//INTERNAL// 	/*@ ensures
//INTERNAL// 		input_dev_unregistered(dev, name, phys, open_cb, close_cb, event_cb, data)
//INTERNAL// 		&*& input_dev_reportable(dev, data);
	
//INTERNAL// 	@*///SYNTAX//

// XXX should check whether this is synchronized (against e.g. unregister)
void *input_get_drvdata(struct input_dev *dev);
//INTERNAL// 	//@ requires [?f]input_dev_reportable(dev, ?userdata);
//INTERNAL// 	//@ ensures [f]input_dev_reportable(dev, userdata) &*& result == userdata;
...
//INTERNAL// 	//@ requires [?f]input_dev_reportable(dev, ?userdata); // XXX hm I thought they synchronize but I should recheck this.
//INTERNAL// 	//@ ensures [f]input_dev_reportable(dev, userdata);
