...
/*GLOBAL*/ (define (spec-invariants st)
/*GLOBAL*/   (define current-addrspace (state-current-addrspace st))
/*GLOBAL*/   (define current-dispatcher (state-current-dispatcher st))
/*GLOBAL*/   (define enclave-mode (state-enclave-mode st))
/*GLOBAL*/   (define (page-typed? pageno type)
/*GLOBAL*/     (&& (page-valid? pageno)
/*GLOBAL*/         (bveq ((state-pagedb.type st) pageno) (bv type 64))))
/*GLOBAL*/   (define (page-nonfree? pageno)
/*GLOBAL*/     (&& (page-valid? pageno)
/*GLOBAL*/         (! (bveq ((state-pagedb.type st) pageno) (bv komodo:KOM_PAGE_FREE 64)))))
/*GLOBAL*/   (define (page->addrspace pageno)
/*GLOBAL*/     ((state-pagedb.addrspace st) pageno))
/*GLOBAL*/   (define-symbolic pageno (bitvector 64))
/*GLOBAL*/   (list
    ; Every addrspace owns itself
/*GLOBAL*/     (forall (list pageno)
/*GLOBAL*/       (=> (page-typed? pageno komodo:KOM_PAGE_ADDRSPACE)
/*GLOBAL*/         (bveq pageno (page->addrspace pageno))))
    ; The owner of a non-free page is a valid page
/*GLOBAL*/     (forall (list pageno)
/*GLOBAL*/       (=> (page-nonfree? pageno)
/*GLOBAL*/         (page-valid? (page->addrspace pageno))))
...
/*GLOBAL*/     (=> enclave-mode
/*GLOBAL*/       (&& (page-typed? current-dispatcher komodo:KOM_PAGE_DISPATCHER)
/*GLOBAL*/           (bveq current-addrspace (page->addrspace current-dispatcher))
/*GLOBAL*/           (addrspace-state? st current-addrspace komodo:KOM_ADDRSPACE_FINAL)))
  ))
...
/*GLOBAL*/     (&& (page-valid? pageno)
/*GLOBAL*/         (! (bveq ((state-pagedb.type st) pageno) (bv komodo:KOM_PAGE_FREE 64)))))
/*GLOBAL*/   (define (page-free? pageno)
/*GLOBAL*/     (page-typed? pageno komodo:KOM_PAGE_FREE))
/*GLOBAL*/   (define (page->addrspace pageno)
/*GLOBAL*/     ((state-pagedb.addrspace st) pageno))
...
/*GLOBAL*/ (define (spec-pgtable-invariants st)
/*GLOBAL*/   (define current-dispatcher (state-current-dispatcher st))
/*GLOBAL*/   (define enclave-mode (state-enclave-mode st))
/*GLOBAL*/   (define (page-typed? pageno type)
/*GLOBAL*/     (&& (page-valid? pageno)
...
/*GLOBAL*/   (define (pgtable-ok? pageno index)
/*GLOBAL*/     (&& (page-valid? pageno)
/*GLOBAL*/         (page-index-valid? index)
/*GLOBAL*/         (page-typed? (page->addrspace pageno) komodo:KOM_PAGE_ADDRSPACE)
/*GLOBAL*/         (! (addrspace-state? st (page->addrspace pageno) komodo:KOM_ADDRSPACE_STOPPED))))
/*GLOBAL*/   (define (pages pageno index)
/*GLOBAL*/     ((state-pages st) pageno index))
/*GLOBAL*/   (define (pgtable-present pageno index)
/*GLOBAL*/     ((state-pgtable-present st) pageno index))
/*GLOBAL*/   (define (pgtable-pn pageno index)
/*GLOBAL*/     ((state-pgtable-pn st) pageno index))
/*GLOBAL*/   (define (pgtable-perm pageno index)
/*GLOBAL*/     ((state-pgtable-perm st) pageno index))
/*GLOBAL*/   (define (pgtable-secure pageno index)
/*GLOBAL*/     ((state-pgtable-secure st) pageno index))

/*GLOBAL*/   (define-symbolic pageno index (bitvector 64))
/*GLOBAL*/   (list
/*GLOBAL*/     (=> enclave-mode
/*GLOBAL*/       (page-typed? current-dispatcher komodo:KOM_PAGE_DISPATCHER))
/*GLOBAL*/     ; l1ptable is correct
/*GLOBAL*/     (forall (list pageno)
/*GLOBAL*/       (=> (&& (page-typed? pageno komodo:KOM_PAGE_ADDRSPACE)
/*GLOBAL*/               (! (addrspace-state? st pageno komodo:KOM_ADDRSPACE_STOPPED)))
/*GLOBAL*/         (&& (page-typed? (state-addrspace.l1pt st pageno) komodo:KOM_PAGE_L1PTABLE)
/*GLOBAL*/             (bveq pageno (page->addrspace (state-addrspace.l1pt st pageno))))))

    ; pgtable pn is synchronized with real page tables
/*GLOBAL*/     (forall (list pageno index)
/*GLOBAL*/       (=> (&& (pgtable-ok? pageno index)
/*GLOBAL*/               (|| (page-typed? pageno komodo:KOM_PAGE_L1PTABLE)
/*GLOBAL*/                   (page-typed? pageno komodo:KOM_PAGE_L2PTABLE)))
/*GLOBAL*/         (bveq (pages pageno index)
/*GLOBAL*/           (if (pgtable-present pageno index)
/*GLOBAL*/               (pfn->pte (page->pfn (pgtable-pn pageno index)) (bv komodo:_PAGE_TABLE 64))
/*GLOBAL*/               (bv 0 64)))))

    ; pgtable leaves are synchronized with real page tables
/*GLOBAL*/     (forall (list pageno index)
/*GLOBAL*/       (=> (&& (pgtable-ok? pageno index)
/*GLOBAL*/               (page-typed? pageno komodo:KOM_PAGE_L3PTABLE))
/*GLOBAL*/         (bveq (pages pageno index)
/*GLOBAL*/           (if (pgtable-present pageno index)
/*GLOBAL*/               (if (pgtable-secure pageno index)
/*GLOBAL*/                   (pfn->pte (page->pfn (pgtable-pn pageno index)) (enclave-prot (pgtable-perm pageno index)))
/*GLOBAL*/                   (pfn->pte (insecure_page->pfn (pgtable-pn pageno index)) (enclave-prot (pgtable-perm pageno index))))
/*GLOBAL*/               (bv 0 64)))))

    ; L1 points to L2
/*GLOBAL*/     (forall (list pageno index)
/*GLOBAL*/       (=> (&& (pgtable-ok? pageno index)
/*GLOBAL*/               (pgtable-present pageno index)
/*GLOBAL*/               (page-typed? pageno komodo:KOM_PAGE_L1PTABLE))
/*GLOBAL*/         (&& (page-typed? (pgtable-pn pageno index) komodo:KOM_PAGE_L2PTABLE)
/*GLOBAL*/             (bveq (page->addrspace pageno) (page->addrspace (pgtable-pn pageno index))))))
...
/*GLOBAL*/               (pgtable-present pageno index)
/*GLOBAL*/               (page-typed? pageno komodo:KOM_PAGE_L2PTABLE))
/*GLOBAL*/         (&& (page-typed? (pgtable-pn pageno index) komodo:KOM_PAGE_L3PTABLE)
/*GLOBAL*/             (bveq (page->addrspace pageno) (page->addrspace (pgtable-pn pageno index))))))
...
/*GLOBAL*/               (pgtable-present pageno index)
/*GLOBAL*/               (page-typed? pageno komodo:KOM_PAGE_L3PTABLE)
/*GLOBAL*/               (pgtable-secure pageno index))
/*GLOBAL*/         (&& (page-typed? (pgtable-pn pageno index) komodo:KOM_PAGE_DATA)
/*GLOBAL*/             (bveq (page->addrspace pageno) (page->addrspace (pgtable-pn pageno index))))))
...
/*GLOBAL*/               (page-typed? pageno komodo:KOM_PAGE_L3PTABLE)
/*GLOBAL*/               (! (pgtable-secure pageno index)))
/*GLOBAL*/         (insecure-page-valid? (pgtable-pn pageno index))))
...
/*GLOBAL*/               (! (page-typed? pageno komodo:KOM_PAGE_L3PTABLE)))
/*GLOBAL*/         (&& (! (pgtable-present pageno index))
/*GLOBAL*/             (bveq (pgtable-pn pageno index) (bv 0 64)))))
...
/*GLOBAL*/               (! (page-typed? pageno komodo:KOM_PAGE_L3PTABLE)))
/*GLOBAL*/         (&& (! (pgtable-secure pageno index))
/*GLOBAL*/             (bveq (pgtable-perm pageno index) (bv 0 64)))))
  ))
